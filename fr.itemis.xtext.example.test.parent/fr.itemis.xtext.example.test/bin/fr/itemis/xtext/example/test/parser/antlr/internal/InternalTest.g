...
entryRuleTgtScript returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTgtScriptRule()); }
	iv_ruleTgtScript=ruleTgtScript
	{ $current=$iv_ruleTgtScript.current; }
	EOF;

// Rule TgtScript
ruleTgtScript returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleDeclareVariable returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getDeclareVariableRule()); }
	iv_ruleDeclareVariable=ruleDeclareVariable
	{ $current=$iv_ruleDeclareVariable.current; }
	EOF;

// Rule DeclareVariable
ruleDeclareVariable returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		otherlv_0='\u58F0\u660E\u53D8\u91CF declareVariable'
		{
...
entryRuleAfterShell returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAfterShellRule()); }
	iv_ruleAfterShell=ruleAfterShell
	{ $current=$iv_ruleAfterShell.current; }
	EOF;

// Rule AfterShell
ruleAfterShell returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleStepShell returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getStepShellRule()); }
	iv_ruleStepShell=ruleStepShell
	{ $current=$iv_ruleStepShell.current; }
	EOF;

// Rule StepShell
ruleStepShell returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRulePreShell returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getPreShellRule()); }
	iv_rulePreShell=rulePreShell
	{ $current=$iv_rulePreShell.current; }
	EOF;

// Rule PreShell
rulePreShell returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleTgtStatement returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTgtStatementRule()); }
	iv_ruleTgtStatement=ruleTgtStatement
	{ $current=$iv_ruleTgtStatement.current; }
	EOF;

// Rule TgtStatement
ruleTgtStatement returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			(
				lv_actionCall_0_0=RULE_ACTION_CALL
				{
		...
		(
			(
				lv_comment_1_0=RULE_TGT_COMMENT
				{
...
entryRuleTgtStep returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTgtStepRule()); }
	iv_ruleTgtStep=ruleTgtStep
	{ $current=$iv_ruleTgtStep.current; }
	EOF;

// Rule TgtStep
ruleTgtStep returns [EObject current=null]
@init {
	enterRule();
}
@after {
